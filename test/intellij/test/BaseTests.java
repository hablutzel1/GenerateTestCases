...
public class BaseTests extends PsiTestCase {
    ...
    protected PsiClass createClassFromTextInPackage(Project project, String text, final String className, final PsiDirectory inPackage) {

        // TODO change it to create classes using JavaDirectoryService
        FileType type = StdFileTypes.JAVA;
        PsiJavaFile javaFile = (PsiJavaFile) PsiFileFactory.getInstance(project).createFileFromText(type, className + ".java", text, 0, text.length());
        ...
        ApplicationManager.getApplication().runWriteAction(new Runnable() {
            public void run() {
                ...
                containingFile.setName(className + ".java");
                inPackage.add(containingFile);
            }
        });
        return createdClass;
    }
